<template>
  <div class="article">
    ...
    <div>
      <rich-content :item="answerList[1]" :user="user"></rich-content>
    </div>
  </div>
</template>
...
export default {
  ...
  setup() {
    ...
    const user = {
      avatar_url:
        'https://pic3.zhimg.com/v2-0d8c455d2355cd8dd0d852a0a309fd46_is.jpg?source=32738c0c',
      name: 'Musiciandd',
      line: 'nihhhhhhhhhhhhhhhhh'
    }
    return {
      answerList,
      user
