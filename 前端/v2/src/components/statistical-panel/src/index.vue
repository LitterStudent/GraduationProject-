<template>
  <div class="statistical">
    ...
    <div class="content">
      <hy-counter-up :number="panelData.price" :option="counterOption2" />
    </div>
    <div class="fotter">
      <span>
        {{ panelData.subTitle }}
        <hy-counter-up :number="panelData.number" :option="counterOption1" />
      </span>
    </div>
  </div>
</template>
...
.statistical {
  ...
  box-shadow: 0 2px 12px 0 rgb(179, 178, 182);
